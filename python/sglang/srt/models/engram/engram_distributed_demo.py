...
if __name__ == '__main__':
    ...
    if engram_cfg.store_backend.lower() == "cxl_shm":
        time.sleep(20) # wait for other process to finish, or if client expiered, the data in mooncake is cleaned
        close_cxl_store()
    elif engram_cfg.store_backend.lower() == "mooncake":
        time.sleep(20) # wait for other process to finish, or if client expiered, the data in mooncake is cleaned
